...
SLOT_ALIAS: dict[tuple[str, str], str] = {
    # L0-00 已发布飞书、正文冻结。它用「先建立生物学直觉」讲机制、
    # 用「当前尚未解决的问题」讲失败与噪声、用「应该学到什么」讲实践。
    ("L0-00", "机制或数学对象"): r"|生物学直觉|建立.*直觉|什么是",
    ("L0-00", "失败与噪声"): r"|尚未解决|容易误读|暴露的问题|边界",
    ("L0-00", "对模型的影响"): r"|关键差异|学到什么|工程判断",
    ("L0-00", "可复现实践"): r"|学到什么|学习顺序|建议",
    ("L0-00", "诊断题"): r"|尚未解决",
    # L0-01 同上（正文冻结，回指改在 notebook/README.md 侧补齐）。
    # 它用 §5.3「显式零值仍然有成本」讲失败、§3.10 讲模型、§7 讲动手。
    ("L0-01", "失败与噪声"): r"|误区|成本|不能混为一谈|缺失什么",
    ("L0-01", "对模型的影响"): r"|模型能|能学到什么|保留了什么",
    ("L0-01", "可复现实践"): r"|审计与可视化|复现脚本|预检|验收标准",
